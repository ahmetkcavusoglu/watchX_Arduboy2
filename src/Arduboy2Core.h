...
#define LEDL 13   /**< The pin number for LEDL. RED */
#define LEDL_PORT PORTC
#define LEDL_BIT PORTC7

#define LEDR 6   /**< The pin number for LEDR. GREEN */
...
#define PIN_1_SPEAKER 9  /**< The pin number of the speaker */
#define SPEAKER_1_PORT PORTB
#define SPEAKER_1_DDR DDRB
#define SPEAKER_1_BIT PORTB5

#define PIN_2_SPEAKER 9  /**< The pin number of the speaker */
...
#define RAND_SEED_IN 12
#define RAND_SEED_IN_PORT PORTD
